...
import TeamItem from '@/components/TeamDataConmenent';
...
const TeamsScreen = () => {
    ...
    return (
        ...
        <ThemedView style={styles.container}>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <TeamItem
                        ...
                        setVisibility={{ setModalVisible: handleVisibilityChange, modlVisible: 0 }}
                    />
                )}
            ...
            </ThemedView><TouchableOpacity onPress={createTeam} style={styles.floatingButton}>
                <Octicons name="plus" size={24} color="white" />
            </TouchableOpacity><TeamAddModal modalVisible={isShowTeamCreatingPanel} setModalVisible={setShowTeamCreatingPanel}></TeamAddModal>
            </ThemedView>
        </>
            );
};
